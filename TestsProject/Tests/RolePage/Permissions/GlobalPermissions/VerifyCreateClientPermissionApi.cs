...
{
    [TestFixture]
    public class VerifyCreateClientPermissionApi : TestSuitBase
    {
        ...
        public void SetUp()
        {
            ...
            roleData.ErpPermissions.Remove("create_client");
        ...
        public void VerifyCreateClientPermissionApiTest()
        {          
           ...
           var actualCreateClientError = _apiFactory
            ...
            Assert.Multiple(() =>
            {
                Assert.True(actualCreateClientError == expectedError,
                    $" expected Create Client Error: {expectedError}" +
                    $" actual Create Client Error: {actualCreateClientError}");
            });
        }
    }
}