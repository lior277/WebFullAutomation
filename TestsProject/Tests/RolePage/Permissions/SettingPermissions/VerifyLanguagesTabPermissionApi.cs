...
{
    [TestFixture]
    public class VerifyLanguagesTabPermissionApi : TestSuitBase
    {
        ...
        public void SetUp()
        {
            ...
            _languageId = _apiFactory
                .ChangeContext<ILanguagesTab>()
                .GetErpLanguagePipe(_crmUrl, languageCode)
                ._id;
        }
        ...
        public void VerifyLanguagesTabPermissionApiTest()
        {
            ...
            var getSettingBySectionName = _apiFactory
                ...
                .GetSettingBySectionNameRequest(_crmUrl, languagesTabSectionNames);
