...
{
    [TestFixture]
    public class VerifySuperAdminTabPermissionsApi : TestSuitBase
    {
        ...
        public void SetUp()
        {
            ...
            _apiFactory
                .ChangeContext<IRolesApi>()
                .WaitForRollToCreate(_crmUrl, _roleName);
        ...
        public void VerifySuperAdminTabPermissionsApiTest()
        {
            var superAdminTabSectionNames = new List<string> { "config/platform",
                "config/currencies", "config/restrictions",
                "config/languages", "config/email", "config/bonus_text", "config/chat",
                "config/risk_restrictions", "config/group_restrictions", "config/group_names",
                "config/chrono", "config/regulation"};

            var expectedErrorMessage = "Method Not Allowed";

            var getSettingBySectionName = _apiFactory
                .ChangeContext<IGeneralTabApi>()
                .GetSettingBySectionNameRequest(_crmUrl, superAdminTabSectionNames);
