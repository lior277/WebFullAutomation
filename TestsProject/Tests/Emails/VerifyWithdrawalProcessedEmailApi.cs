...
{
    [TestFixture]
    public class VerifyWithdrawalProcessedEmailApi : TestSuitBase
    {
        ...
        public void VerifyWithdrawalProcessedEmailApiTest()
        {
            ...
            var emailsParams = new Dictionary<string, string> { 
                { "type", "withdrawal_processed" }, { "language", "en" }, { "subject", subject }};
           ...
           _apiFactory
                ...
                _withdrawalId, apiKey: _userApiKey);
