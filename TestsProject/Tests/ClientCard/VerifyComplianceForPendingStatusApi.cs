...
namespace TestsProject.Tests.ClientCard
{
    ...
    public class VerifyComplianceForPendingStatusApi : TestSuitBase
    {
        public VerifyComplianceForPendingStatusApi(string browser) : base(browser)
        {
        ...
        public void SetUp()
        {
            ...
            var rateForPending = currentRate + 100; // to open a pending trade
        ...
        public void VerifyComplianceForPendingStatusApiTest()
        {
            ...
            var expectetaCreateDepositError = "Please activate your account before you proceed" +
                " with this action. For more information, kindly contact your manager. Thank you";

            var expectetCreateWithdrawalErrorMessage = "active_your_account";

            var expectetCreateTradeErrorMessage = "active_your_account_before_open_trade";

            var expectetComplianceStatusToolTipText = "Pending Allowed" +
                " Cancel withdrawal requests Transfer from Balance to SA and from SA to Balance Not allowed Trade Deposit Withdraw";
               ...
               var actualComplianceStatusToolTipText = _apiFactory
                ...
                .SelectComplianceStatus("Pending")
           ...
           _apiFactory
            ...
            // buy chrono trade 
            var actualCloseChronoErrorMessage = _apiFactory
                .ChangeContext<IChronoTradePageApi>()
                .PatchCloseChronoTradeRequest(_tradingPlatformUrl, _chronoId,
                _loginData, checkStatusCode: false);

            Assert.Multiple(() =>
            {
                Assert.True(actualCreateDepositError == expectetaCreateDepositError,
                    $" expected Create Deposit Error Message: {expectetaCreateDepositError}," +
                    $" actual Create Deposit Error Message: {actualCreateDepositError}");

                Assert.True(actualCreateWithdrawalError.Contains(expectetCreateWithdrawalErrorMessage),
                    $" expected Create Withdrawal Error Message: {expectetCreateWithdrawalErrorMessage}," +
                ...
                Assert.True(actualPendingTradeAmountError.Contains(expectetCreateWithdrawalErrorMessage),
                    $" expected Pending Trade change Amount Error Message: {expectetCreateWithdrawalErrorMessage}," +
