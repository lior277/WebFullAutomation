...
namespace TestsProject.Tests.MarketExposure
{
    ...
    public class VerifyLongShortAndTotalBoxesOnMarketExposure : TestSuitBase
    {
        #region members
        ...
        private int _depositAmount = 200000;
        private int _buyAmount = 10;
        ...
        public VerifyLongShortAndTotalBoxesOnMarketExposure(string browser) : base(browser)
        {
        ...
        public void SetUp()
        {
            ...
            var tradeDetails = _apiFactory
                ...
                .PostBuyAssetRequest(_tradingPlatformUrl, _buyAmount, loginCookies)
                .GeneralResponse;
            #endregion
            ...
            // long amount in USD
            var longAmount = _buyAmount * currentRate;

            // long amount in EUR
            _expectedLongPositionAmount = _apiFactory
                .ChangeContext<IGeneral>(_driver)
                .PostCurrencyConversionRequest(_crmUrl, longAmount, DataRep.DefaultUSDCurrencyName, "EUR");
            ...
            //_expectedLongPositionAmount = Convert.ToInt32(tempLongPositionAmount);

            // short amount in USD
            var shortAmount = _sellAmount * currentRate;

            // short amount in EUR
            _expectedShortPositionAmount = _apiFactory
                .ChangeContext<IGeneral>(_driver)
                .PostCurrencyConversionRequest(_crmUrl, shortAmount, DataRep.DefaultUSDCurrencyName, "EUR");

            //_expectedShortPositionAmount = Convert.ToInt32(tempShortPositionAmount);
        }
        #endregion
